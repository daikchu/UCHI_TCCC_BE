...
public class ContractTemplate extends BaseEntityBeans {
  private Long id;
  private String name;
  ...
  public ContractTemplate(){}
    ...
    public ContractTemplate(Long id, String name, Long kind_id, Long kind_id_tt08, String code, String description, String file_name, String file_path, Long active_flg, Long relate_object_number, String relate_object_a_display, String relate_object_b_display, String relate_object_c_display, Long period_flag, Long period_req_flag, Long mortage_cancel_func, Long sync_option, Long entry_user_id, String entry_user_name, String entry_date_time, Long update_user_id, String update_user_name, String update_date_time, String kind_html,Long code_template) {
        this.id = id;
        this.name = name;
