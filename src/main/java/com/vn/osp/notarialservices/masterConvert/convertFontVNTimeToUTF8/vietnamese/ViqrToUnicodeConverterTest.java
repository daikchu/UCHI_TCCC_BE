...
//import java.io.File;
//
//public class ViqrToUnicodeConverterTest {
//
...
//        converter = converterFactory.build(VietnameseEncoding.Encoding.VIQR);
//    }
//
//    @Test
//    public void testConvertTextFile_input1() throws Exception {
//        File inputFile = new File(getClass().getResource("/input/input_1/input_1_viqr.txt").getPath());
...
//        File inputFile = new File(getClass().getResource("/input/input_2/input_2_viqr.txt").getPath());
...
//
//    @Test
//    public void testConvertTextFile_input3() throws Exception {
//        File inputFile = new File(getClass().getResource("/input/input_3/input_3_viqr.txt").getPath());
//        File outputFile = new File(getClass().getResource("/output/output_3.txt").getPath());
//
//        String expectedContent = FileHelper.readContent(outputFile, FileHelper.CHARSET_UTF_8);
//        String convertedContent = converter.convert(inputFile);
//        Assert.assertTrue(expectedContent.equals(convertedContent));
