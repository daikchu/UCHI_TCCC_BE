...
//import java.io.File;
//
//public class Tcvn3ToUnicodeConverterTest {
//
...
//        converter = converterFactory.build(VietnameseEncoding.Encoding.TCVN3);
//    }
//
//    @Test
//    public void testConvertTextFile_input1() throws Exception {
//        File inputFile = new File(getClass().getResource("/input/input_1/input_1_tcvn3.txt").getPath());
...
//        File inputFile = new File(getClass().getResource("/input/input_2/input_2_tcvn3.txt").getPath());
