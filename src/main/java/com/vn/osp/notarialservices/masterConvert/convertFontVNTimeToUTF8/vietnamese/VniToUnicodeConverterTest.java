...
//import java.io.File;
//
//public class VniToUnicodeConverterTest {
//
...
//        converter = converterFactory.build(VietnameseEncoding.Encoding.VNI);
//    }
//
//    @Test
//    public void testConvertTextFile_input1() throws Exception {
//        File inputFile = new File(getClass().getResource("/input/input_1/input_1_vni.txt").getPath());
...
//        File inputFile = new File(getClass().getResource("/input/input_2/input_2_vni.txt").getPath());
...
//
//    @Test
//    public void testConvertHtmlFile() throws Exception {
//        File inputFile = new File(getClass().getResource("/input/input_3/input_3_vni.html").getPath());
//        File outputFile = new File(getClass().getResource("/output").getPath() + "/output_3.html");
//
//        String convertedContent = converter.convert(inputFile);
//        String expectedContent = FileHelper.readContent(outputFile, FileHelper.CHARSET_UTF_8);
//        Assert.assertTrue(expectedContent.equals(convertedContent));
