...
//import java.io.File;
//
//public class VisciiToUnicodeConverterTest {
//
...
//        converter = converterFactory.build(VietnameseEncoding.Encoding.VISCII);
//    }
//
//    @Test
//    public void testConvertTextFile_input1() throws Exception {
//        File inputFile = new File(getClass().getResource("/input/input_1/input_1_viscii.txt").getPath());
...
//        File inputFile = new File(getClass().getResource("/input/input_2/input_2_viscii.txt").getPath());
