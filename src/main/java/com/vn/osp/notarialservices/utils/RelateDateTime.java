...
public class RelateDateTime {
    ...
    public static String formatDate1 (String date) {
        ...
        String dateString2 = new SimpleDateFormat("yyyy-MM-dd").format(dates);
        return dateString2;
    }
    ...
    public static boolean checkFormatDDMMYYYY(String date){
        if(org.apache.commons.lang3.StringUtils.isBlank(date)) return false;
        Date initDate=null;
        try{
